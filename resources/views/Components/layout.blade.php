    ...
    <nav class="bg-gray-800">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <!-- : = Indica que es una expresión(bool(en mi caso), ...), y no un acadena de texto -->
              ...
              <div class="relative ml-3">
                <div>
                  <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="size-8 rounded-full" src="{{ asset('images/fotoMaria.JPEG') }}" alt="">
                  </button>
                </div>
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
          <x-nav2 href="/" :active="request()->is('/')">Home</x-nav2>
          <x-nav2 href="/jobs" :active="request()->is('jobs')">Jobs</x-nav2>
          <x-nav2 href="/contact" :active="request()->is('contact')">Contact</x-nav2>
        </div>
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="{{ asset('images/fotoMaria.JPEG') }}" alt="">
            </div>
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Maria Ortiz</div>
              <div class="text-sm font-medium text-gray-400">mariamontewei10@gmail.com</div>
            </div>
